...
class COV_Email_Customer_Order_Cancelled extends WC_Email {
	...
	public function __construct() {
		...
		$this->id          = 'cov_customer_order_cancelled';
		$this->title       = __( 'Customer Order Cancelled', 'cod-verify-for-woocommerce' );
		$this->description = __(
			'Email sent to the customer when a COD order is automatically cancelled because verification was not completed before the timeout.',
			'cod-verify-for-woocommerce'
		);

		$this->customer_email = true;

		$this->template_html  = 'emails/customer-order-cancelled.php';
		$this->template_plain = 'emails/plain/customer-order-cancelled.php';
