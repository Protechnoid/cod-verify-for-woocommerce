...
class COV_Email_Customer_Order_Confirmed extends WC_Email {
	...
	public function __construct() {
		...
		$this->id          = 'cov_customer_order_confirmed';
		$this->title       = __( 'Customer Order Confirmed', 'cod-verify-for-woocommerce' );
		$this->description = __(
			'Email sent to the customer after successfully confirming a COD order.',
			'cod-verify-for-woocommerce'
		);

		$this->customer_email = true;

		$this->template_html  = 'emails/customer-order-confirmed.php';
		$this->template_plain = 'emails/plain/customer-order-confirmed.php';
