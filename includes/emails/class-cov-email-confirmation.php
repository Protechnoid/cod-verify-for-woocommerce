...
class COV_Email_Confirmation extends WC_Email {
	...
	public function __construct() {
		...
		$this->id          = 'cov_customer_confirmation';
		$this->title       = __( 'Customer Confirmation', 'cod-verify-for-woocommerce' );
		$this->description = __(
			'Email sent to customers requesting COD order confirmation.',
